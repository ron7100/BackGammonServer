...
namespace BackGammonServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = this.Configuration.GetConnectionString("BackgammonDB");
            services.AddDbContext<BackGammonDBContext>(options => options.UseSqlServer(connectionString));
        }
